...
Si ahora revisamos los dashboards de `Eureka Server` y de `Zipkin` veremos que nuestro `user-service` ha sido registrado
correctamente y está enviando trazas sin problemas.